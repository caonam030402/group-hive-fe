...
export const sizeWorkplaceList = [
...
export const industriesList = [
  {
    category: "Online and IT Industries",
    fields: [
      { name: "Information Technology & Services", value: 1 },
      { name: "Internet", value: 2 },
      { name: "Computer Software", value: 3 },
      { name: "Telecommunications", value: 4 },
      { name: "E-learning", value: 5 },
      { name: "Online Publishing", value: 6 },
      { name: "Digital Marketing", value: 7 },
      { name: "Web Development", value: 8 },
    ],
  },
  {
    category: "Creative Online Industries",
    fields: [
      { name: "Media Production", value: 9 },
      { name: "Entertainment", value: 10 },
      { name: "Design", value: 11 },
      { name: "Arts & Crafts", value: 12 },
      { name: "Graphic Design", value: 13 },
      { name: "Photography", value: 14 },
    ],
  },
  {
    category: "E-Commerce and Online Services",
    fields: [
      { name: "Retail", value: 15 },
      { name: "E-commerce", value: 16 },
      { name: "Logistics & Supply Chain", value: 17 },
      { name: "Consumer Services", value: 18 },
    ],
  },
  {
    category: "Education and Training",
    fields: [
      { name: "Education Management", value: 19 },
      { name: "E-learning", value: 20 },
      { name: "Professional Training", value: 21 },
      { name: "Program Development", value: 22 },
    ],
  },
];
